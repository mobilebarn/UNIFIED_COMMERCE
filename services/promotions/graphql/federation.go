...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "DiscountCode":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "DiscountCode": %w`, err)
			}
			switch resolverName {
			...
			case "findDiscountCodeByID":
				id0, err := ec.unmarshalNID2string(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findDiscountCodeByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindDiscountCodeByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "DiscountCode": %w`, err)
				}
		...
		case "Promotion":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Promotion": %w`, err)
			}
			switch resolverName {
			...
			case "findPromotionByID":
				id0, err := ec.unmarshalNID2string(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findPromotionByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindPromotionByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Promotion": %w`, err)
				}
...
func entityResolverNameForDiscountCode(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m   map[string]interface{}
			val interface{}
	...
	return "", fmt.Errorf("%w for DiscountCode", ErrTypeNotFound)
}

func entityResolverNameForPromotion(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m   map[string]interface{}
			val interface{}
	...
	return "", fmt.Errorf("%w for Promotion", ErrTypeNotFound)
}
