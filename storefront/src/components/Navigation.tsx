        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden md:block relative">
              ...
              <button className="absolute right-3 top-2.5 h-5 w-5 text-gray-400 hover:text-blue-600">
            ...
            <div className="relative group">
              <Link href="/account" className="text-gray-600 hover:text-blue-600 p-2">
              ...
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
                <div className="py-1">
                  ...
                  <button className="block w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-gray-100 border-t border-gray-100">Sign Out</button>
                </div>
              </div>
            </div>
        ...
        <div className="md:hidden border-t border-gray-200 bg-white">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <div className="border-t border-gray-200 pt-4 pb-2">
              ...
              <button className="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-red-600 hover:bg-gray-50">
                Sign Out
              </button>
            </div>
          </div>
