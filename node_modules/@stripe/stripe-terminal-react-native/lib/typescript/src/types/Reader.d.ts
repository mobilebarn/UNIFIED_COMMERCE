...
export declare namespace Reader {
    ...
    namespace IOS {
        ...
        type DiscoveryMethod = 'bluetoothProximity' | 'bluetoothScan' | 'internet' | 'tapToPay';
    }
    namespace Android {
        type Type = {
            baseUrl?: string;
    ...
    type DeviceType = 'chipper1X' | 'chipper2X' | 'stripeM2' | 'verifoneP400' | 'wiseCube' | 'wisePad3' | 'wisePosE' | 'wisePad3s' | 'wisePadEDevkit' | 'stripeS700Devkit' | 'stripeS700' | 'stripeS710Devkit' | 'stripeS710' | 'cotsDevice' | 'tapToPay' | 'etna';
