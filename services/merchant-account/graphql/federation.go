...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "Merchant":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Merchant": %w`, err)
			}
			switch resolverName {
			...
			case "findMerchantByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findMerchantByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindMerchantByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Merchant": %w`, err)
				}
...
func entityResolverNameForMerchant(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
	...
	return "", fmt.Errorf("%w for Merchant", ErrTypeNotFound)
}
