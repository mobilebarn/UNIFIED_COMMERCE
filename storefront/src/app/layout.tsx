...
export const metadata: Metadata = {
  title: "Unified Commerce OS - Your Complete Commerce Platform",
  description: "Your unified commerce solution for modern businesses and customers",
};
              ...
              <footer className="bg-gray-900 text-gray-300">
                <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    {/* Company Info */}
                    <div>
                      <h3 className="text-white text-lg font-bold mb-4">Unified Commerce OS</h3>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        ...
                        <li><a href="/products" className="text-gray-400 hover:text-white transition">Shop</a></li>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        <li><a href="/account" className="text-gray-400 hover:text-white transition">My Account</a></li>
                        <li><a href="/account/orders" className="text-gray-400 hover:text-white transition">Order History</a></li>
                  ...
                  <div className="mt-12 border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-sm">© 2025 Unified Commerce OS. All rights reserved.</p>
